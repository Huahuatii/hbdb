<template>
  <div class="mycontent">
    ...
    <el-breadcrumb :separator-icon="ArrowRight" style="padding: 30px 15px;float: left;">
      ...
      <el-breadcrumb-item :to="{ path: '/search/t' }" style="font-size: 24px;">Target</el-breadcrumb-item>
      <el-breadcrumb-item style="font-size: 24px;">{{ data1.dataList.protein_name }}</el-breadcrumb-item>
  ...
  <div class="mycontent2">
    <el-descriptions class="margin-top" :title="data1.dataList.protein_name" :column="1" :size="size" border>
      <template #extra>
...
import { get_T_data } from '../../utils/request.js'
...
get_T_data(data, getqyinfo).then(res => {
  if (res) {
    data1.dataList = res
...
var getqyinfo = url.split('details/')[1]
