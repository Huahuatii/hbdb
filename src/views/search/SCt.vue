  ...
  <div class="bc1">
    ...
    <div class="mypagination">
      <el-pagination v-model:currentPage="data.searchParams.pagenum" v-model:page-size="data.searchParams.pagesize"
        :page-sizes="[5, 10, 25, 50]" background='true' layout="total, sizes, prev, pager, next, jumper" :total="data.total" @size-change="searchT" @current-change="searchT"
        />
    </div>
  </div>
</template>
...
const searchT = () => {
  get_T_data(data.searchParams).then(res => {
